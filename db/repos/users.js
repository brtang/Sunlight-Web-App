module.exports = (rep, pgp) => {
   return{
      ...
      insert: values =>
        rep.any('INSERT INTO Users(Name, Password, Email, Company, Role) VALUES (${Name}, ${Password} , ${Email}, ${Company}, ${Role}) RETURNING Name, User_Id',values, user => user.Name && user.User_Id),
